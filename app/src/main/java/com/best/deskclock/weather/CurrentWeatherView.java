 ...
 *
 */
package com.best.deskclock.weather;
...
public class CurrentWeatherView extends FrameLayout implements OmniJawsClient.OmniJawsObserver {
    ...
    public CurrentWeatherView(Context context) {
        this(context, null);
        Log.d(TAG, "Weather view created.");
        mContext = context;
    }
    ...
    protected void onFinishInflate() {
        ...
        mCurrentImage  = (ImageView) findViewById(R.id.weather_current_image);
        mLeftText = (TextView) findViewById(R.id.weather_left_text);
        mRightText = (TextView) findViewById(R.id.weather_right_text);
        if (mLeftText == null) {
            Log.wtf(TAG, "Whoops! findViewById returned null. App will now crash.");
        }
